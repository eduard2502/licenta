...
public UserDto updateUser(Long id, UserUpdateDto userUpdateDto) {
    ...
    System.out.println("Update data - fullName: " + userUpdateDto.getFullName());
    System.out.println("Update data - phone: " + userUpdateDto.getPhone());
    System.out.println("Update data - address: " + userUpdateDto.getAddress());

    // Update email
    existingUser.setEmail(userUpdateDto.getEmail());
    
    // Update the new profile fields
